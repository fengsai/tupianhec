...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        finish: function(e) {
            ...
            var _fsprovinceText=provinceText;
            var _fscityText=((cityText)?('' + cityText):(''));
            var _fscountyText=((countyText)?('' + countyText):(''));
            _self.trigger.value = provinceText + ((cityText)?('' + cityText):(''))+ ((countyText)?('' + countyText):(''));
            if(_self.trigger.innerHTML)
            {
                if(_self.callback)
                {
                    _self.callback([_fsprovinceText,_fscityText,_fscountyText]);
                }
            }
